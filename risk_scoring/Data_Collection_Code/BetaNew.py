...
#initialize equity and index daily return 
    ...
    for lim in range(2, comp_sheet.nrows):
        ...
        wsheet.write(lim, 0, str(comp_sheet.cell_value(lim, 3)))
    ...
    for i in range(0,11):               #for 11 years of Data of daily open and close value            
        ...
        for eachCompany in range(3,sheet.ncols,2):
            ...
            wsheet.write(((eachCompany+1)/2),i+1,beta)
...
workbook = xlrd.open_workbook("/home/ashwath/PycharmProjects/risk_scoring/Data_Collection_Code/DataSet_Final.xlsx")
#sheet = workbook.sheet_by_name("TS")
