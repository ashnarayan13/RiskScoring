...
sheet2 = wb2.add_sheet("CASHEQUITY")
sheet3 = wb2.add_sheet("EQUITY")
#wb = Workbook()
#ws = wb.active
...
for rows in range(3, s1.nrows):
    ...
    sheet3.write(rows-1,2,s1.cell_value(rows,19))
    sheet3.write(rows-1,3,s2.cell_value(rows,19))
    sheet3.write(rows-1,4,s3.cell_value(rows,19))
    sheet3.write(rows-1,5,s4.cell_value(rows,19))
    sheet3.write(rows-1,6,s5.cell_value(rows,19))
    sheet3.write(rows-1,7,s6.cell_value(rows,19))
    sheet2.write(rows-1,2,s1.cell_value(rows,22))
    sheet2.write(rows-1,3,s2.cell_value(rows,22))
    sheet2.write(rows-1,4,s3.cell_value(rows,22))
    sheet2.write(rows-1,5,s4.cell_value(rows,22))
    sheet2.write(rows-1,6,s5.cell_value(rows,22))
    sheet2.write(rows-1,7,s6.cell_value(rows,22))
wb2.save('DEBT_EQUITY.xlsx')
print("complete")
